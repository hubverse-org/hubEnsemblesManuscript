...
> Li Shandross, Emily Howerton, Lucie Contamin, Harry Hochheiser, Anna Krystalli, Consortium of Infectious Disease Mdodeling Hubs, Nicholas G. Reich, Evan L. Ray (in prep). *`hubEnsembles`: Ensembling Methods in R*. 
...
> Li Shandross, Emily Howerton, Lucie Contamin, Harry Hochheiser, Anna Krystalli, Consortium of Infectious Disease Mdodeling Hubs, Nicholas G. Reich, Evan L. Ray (in prep). *Compendium of R code and data for `hubEnsembles`:
...
- [:file_folder: paper](/analysis/paper): Quarto source document for
  manuscript. Includes style files and code to reproduce the figures and tables
...
- run `devtools::install()` to ensure you have the packages this
  ...
  file). You can use `renv::restore()` to load all necessary pacakges. 
