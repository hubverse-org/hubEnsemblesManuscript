...
Table: (\#tab:model-output-rep) A table summarizing how the model output representation columns are used for predictions of different output types. Adapted from [@hubverse_docs].
