...
To demonstrate the utility of the [hubEnsembles]{.pkg} package and the differences between the two ensembling functions, we examine a second set of weekly influenza hospitalizations forecasts for the US.
