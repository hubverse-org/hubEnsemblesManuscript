...
-   *Output type*: a classification of model output that is supported by the hubverse (i.e., the types of predictions that can be processed). See Table @tbl-model-output-rep for definitions of each.
