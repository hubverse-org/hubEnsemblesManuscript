...
We can use additional functions from the `evaluation_functions.R` script to examine model performance with greater granularity. For example, we may use the following lines of code to generate a table similar to @tbl-overall-evaluation but that shows scores from week to week.
