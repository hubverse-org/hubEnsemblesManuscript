...
In addition to these six output types mentioned above, other types of predictions not explicitly defined in the hubverse may be represented within model output. For example, trajectories may be encoded as the "sample" output type while predictions of binary events can be captured using the "pmf" output type.
