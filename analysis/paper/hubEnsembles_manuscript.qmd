...
library(hubUtils)
readr::read_rds("../data/raw_data/flu_forecasts_raw.rds") |>
...
A table summarizing how the model output representation columns are used for predictions of different output types. Adapted from [@hubverse_docs].
:::
...
flu_forecasts_raw <- readr::read_rds("../data/raw_data/flu_forecasts_raw.rds")
...
flu_truth_all <- readr::read_rds("../data/raw_data/flu_truth_all.rds")
flu_files <- list.files(path = "../data/raw_data", pattern = "hub", full.names = TRUE)
...
flu_scores_baseline <- readr::read_rds("../data/raw_data/flu_baseline_scores.rds")
flu_scores_ensembles <- readr::read_rds("../data/raw_data/flu_scores_ensembles.rds")
