...
#| target data for California. Panel A shows the baseline and four ensembles
#| plotted together on the same scale. Panel B contains facets plotting forecasts
#| for each individual model, with varying y-axis scales. All plots show the 
#| various forecasts' prediction accuracy as compared to observed influenza
#| hospitalizations."
#| fig-width: 9
#| fig-height: 11
