...
#| distinct scenarios. This example is a subset of the
...
cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    "", l, l2, "", nrow = 1, rel_widths = c(0.175, 0.325, 0.325, 0.175)),
...
#| displayed. This example data is provided in the `hubEnsembles` package and is
#| a subset of the `example-complex-forecast-hub` data provided by the
...
#| quantile output type and all bins for the pmf output type."
mean_ens |>
  dplyr::filter(
