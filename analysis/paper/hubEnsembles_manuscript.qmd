...
#| `target_end_date` (date of occurrence for the outcome of interest) columns 
...
# readr::read_rds(
#   here::here("analysis/data/derived_data/flu_forecasts-small.rds")
# ) |>
...
Each unique prediction from an ensemble model is scored against target data using the `score_forecasts()` function[^2] from the [covidHubUtils]{.pkg} package. This function outputs each of the metrics described above. We use median forecasts taken from the 0.5 quantile for the MAE evaluation.
