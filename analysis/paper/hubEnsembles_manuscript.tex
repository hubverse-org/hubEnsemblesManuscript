...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, frame hidden, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
forecasts in this example were made on 2022-12-17 for Minnesota. This
example is a subset of the \texttt{forecast\_outputs} data provided by
the \pkg{hubExamples} package.}
