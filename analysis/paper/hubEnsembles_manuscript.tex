...
more in-depth analysis using real influence of forecasts
...
\texttt{target\_end\_date} (date of occurrence for the outcome of
interest) columns have been omitted for brevity. This example data is
provided in the \pkg{hubExamples} package.}
...
\texttt{flu\_forecasts-raw\_22-23.rds}.
...
We exclude component forecasts from the ensemble calculations if any
...
also exclude the FluSight baseline and median ensemble models that were
