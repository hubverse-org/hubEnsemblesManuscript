...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toptitle=1mm, toprule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and Definitions}, titlerule=0mm, opacityback=0, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, left=2mm, colback=white]
