...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, rightrule=.15mm, colback=white, opacityback=0, toprule=.15mm, breakable, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Concepts in statistical forecasting}, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, rightrule=.15mm, colback=white, opacityback=0, toprule=.15mm, breakable, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Terminology from the hubverse}, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, coltitle=black]
...
\SpecialCharTok{\textgreater{}} \FunctionTok{ggsave}\NormalTok{(}\StringTok{"../figures/Shandross\_fig3.tiff"}\NormalTok{, }\AttributeTok{dpi=}\DecValTok{800}\NormalTok{, }\AttributeTok{width=}\DecValTok{8}\NormalTok{, }\AttributeTok{height=}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\SpecialCharTok{\textgreater{}} 
\ErrorTok{\textgreater{}} \FunctionTok{ggsave}\NormalTok{(}\StringTok{"../figures/Shandross\_fig4.tiff"}\NormalTok{, }\AttributeTok{dpi=}\DecValTok{800}\NormalTok{, }\AttributeTok{width=}\DecValTok{8}\NormalTok{, }\AttributeTok{height=}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
when making predictions for influenza season with an unusually large
