...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, titlerule=0mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Concepts in statistical forecasting}, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\item
  ...
  generated from a model. Here, used to encapsulate a range of outcomes
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, titlerule=0mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Terminology from the hubverse}, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, opacityback=0]
...
\item
  ...
  processed). See Table~\ref{tbl-model-output-rep} for definitions of
  each.
\item
...
data object provides observed values for weekly incident influenza
hospitalizations and weekly rate change of influenza hospitalizations in
a given week for a particular location using columns
\texttt{observation}, \texttt{target\_end\_date}, \texttt{location}, and
\texttt{target}. The forecast-specific task ID variables
\texttt{reference\_date} and \texttt{horizon} are not relevant for this
time series representation of the target data, and are thus not included
as columns.
...
the target, location, and time horizons we are interested in.
...
\SpecialCharTok{+}\NormalTok{   dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(}
\SpecialCharTok{+}\NormalTok{     target }\SpecialCharTok{==} \StringTok{"wk inc flu hosp"}\NormalTok{,}
\SpecialCharTok{+}\NormalTok{     location }\SpecialCharTok{==} \StringTok{"25"}\NormalTok{,}
\SpecialCharTok{+}\NormalTok{     target\_end\_date }\SpecialCharTok{\textgreater{}=} \StringTok{"2022{-}11{-}01"}\NormalTok{, target\_end\_date }\SpecialCharTok{\textless{}=} \StringTok{"2023{-}03{-}01"}
...
\SpecialCharTok{+}   \AttributeTok{x\_target\_col\_name =} \StringTok{"target\_end\_date"}\NormalTok{,}
...
ranking of the models differs slightly among the four scoring metrics;
...
\url{https://github.com/hubverse-org/hubEnsemblesManuscript} and
archived at \textbf{ADD HERE}, including required package versions which
are available in the \texttt{renv.lock} file.
...
\bibitem[\citeproctext]{ref-sherratt_characterising_2024}
\CSLLeftMargin{47. }%
...
series data for incident influenza hospitalizations and (weekly)
influenza hospitalization rate change. We round the latter target's
observed values (in the \texttt{observation} column) to three digits for
readability. This table displays target time series data for
Massachusetts (FIPS code 25) between 2022-11-01 and 2023-02-01. The
target data is provided in the \texttt{hubExamples} package.}

\tabularnewline

\toprule\noalign{}
\texttt{target\_end\_date} & \texttt{target} & \texttt{location} &
\texttt{observation} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
2022-11-05 & wk inc flu hosp & 25 & 31.000 \\
2022-11-12 & wk inc flu hosp & 25 & 43.000 \\
2022-11-19 & wk inc flu hosp & 25 & 79.000 \\
2022-11-26 & wk inc flu hosp & 25 & 221.000 \\
2022-12-03 & wk inc flu hosp & 25 & 446.000 \\
2022-12-10 & wk inc flu hosp & 25 & 578.000 \\
2022-12-17 & wk inc flu hosp & 25 & 694.000 \\
2022-12-24 & wk inc flu hosp & 25 & 769.000 \\
2022-12-31 & wk inc flu hosp & 25 & 733.000 \\
2023-01-07 & wk inc flu hosp & 25 & 466.000 \\
2023-01-14 & wk inc flu hosp & 25 & 238.000 \\
2023-01-21 & wk inc flu hosp & 25 & 122.000 \\
2023-01-28 & wk inc flu hosp & 25 & 71.000 \\
2022-11-05 & wk flu hosp rate & 25 & 0.444 \\
2022-11-12 & wk flu hosp rate & 25 & 0.616 \\
2022-11-19 & wk flu hosp rate & 25 & 1.132 \\
2022-11-26 & wk flu hosp rate & 25 & 3.167 \\
2022-12-03 & wk flu hosp rate & 25 & 6.391 \\
2022-12-10 & wk flu hosp rate & 25 & 8.282 \\
2022-12-17 & wk flu hosp rate & 25 & 9.945 \\
2022-12-24 & wk flu hosp rate & 25 & 11.019 \\
2022-12-31 & wk flu hosp rate & 25 & 10.503 \\
2023-01-07 & wk flu hosp rate & 25 & 6.677 \\
2023-01-14 & wk flu hosp rate & 25 & 3.410 \\
2023-01-21 & wk flu hosp rate & 25 & 1.748 \\
2023-01-28 & wk flu hosp rate & 25 & 1.017 \\
