...
all \texttt{hubEnsembles} functions, model predictions in other formats
can easily be transformed using the \texttt{as\_model\_out\_tbl()}
function from {hubUtils}. An example of this transformation is provided
...
``truth'' data), which are stored in the {hubExamples} package as data
objects named \texttt{forecast\_outputs}, \texttt{forecast\_target\_ts},
and \texttt{forecast\_oracle\_output}. Note that this model outputs data
