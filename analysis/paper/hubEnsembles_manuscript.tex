...
``task IDs''), or specify the prediction itself and how it is
represented (called the ``model output representation'')
\citep{hubverse_docs}.
...
\(F^{-1}(\theta)\), cumulative probability, \(F(x)\), or probability
