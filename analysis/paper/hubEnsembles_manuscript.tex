...
\hypersetup{
  pdftitle={hubEnsembles: Ensembling Methods in },
...
\Plaintitle{hubEnsembles: Ensembling Methods in} %% without formatting
...
benefits. The \proglang{R} package \texttt{hubEnsembles} provides a
...
needed to utilize the \pkg{hubEnsembles} package, then explain the
