...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, bottomrule=.15mm, rightrule=.15mm, breakable, opacitybacktitle=0.6, left=2mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and Definitions}, arc=.35mm, toptitle=1mm, leftrule=.75mm, colback=white, colframe=quarto-callout-tip-color-frame]
...
\item
  \emph{Probabilistic prediction}: a prediction that quantifies the a
