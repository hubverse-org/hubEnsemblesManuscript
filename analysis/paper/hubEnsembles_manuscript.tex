...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, titlerule=0mm, coltitle=black, leftrule=.75mm, colback=white, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Concepts in statistical forecasting}, colframe=quarto-callout-tip-color-frame, breakable, rightrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, titlerule=0mm, coltitle=black, leftrule=.75mm, colback=white, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Terminology from the hubverse}, colframe=quarto-callout-tip-color-frame, breakable, rightrule=.15mm, left=2mm]
...
\SpecialCharTok{\textgreater{}} \FunctionTok{ggsave}\NormalTok{(}\StringTok{"../figures/Shandross\_fig3.pdf"}\NormalTok{, }\AttributeTok{dpi=}\DecValTok{800}\NormalTok{, }\AttributeTok{width=}\DecValTok{8}\NormalTok{, }\AttributeTok{height=}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
