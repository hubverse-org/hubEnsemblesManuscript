...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, coltitle=black, breakable, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Keywords and definitions: Terminology from the hubverse}, toprule=.15mm, arc=.35mm, leftrule=.75mm, left=2mm]
