...
+}
R> 
R> geometric_mean_ens <- hubEnsembles::example_model_output |>
...
+)
R> 
R> weighted_mean_ens <- hubEnsembles::example_model_output |>
+  hubEnsembles::simple_ensemble(
...
\begin{verbatim}
R> linear_pool_ens <- hubEnsembles::example_model_output |>
